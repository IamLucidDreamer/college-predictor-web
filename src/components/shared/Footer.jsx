        ...
        <div class="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
          <div class="lg:w-1/6 md:w-1/2 w-full px-4">
            ...
            <nav class="list-none mb-10">
              <li>
                <a class="text-gray-200 hover:text-primary">First Link</a>
              </li>
              <li>
                <a class="text-gray-200 hover:text-primary">Second Link</a>
              </li>
              <li>
                <a class="text-gray-200 hover:text-primary">Third Link</a>
              </li>
              <li>
                <a class="text-gray-200 hover:text-primary">Fourth Link</a>
              </li>
            </nav>
          </div>
          <div class="lg:w-1/6 md:w-1/2 w-full px-4">
        ...
        <div class="container px-5 py-8 flex flex-wrap mx-auto items-center">
          <div class="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
            <div class="relative sm:w-64 w-40 sm:mr-4 mr-2">
              <label for="footer-field" class="leading-7 text-sm text-gray-200">
                Placeholder
              </label>
              <input
                type="text"
            ...
            <button class="inline-flex text-white bg-primary border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded-full">
              Subscribe
            </button>
            <p class="text-gray-500 text-sm md:ml-6 md:mt-0 mt-2 sm:text-left text-center">
              Bitters chicharrones fanny pack
              <br /> <span class="lg:block hidden">waistcoat green juice</span>
            </p>
          </div>
